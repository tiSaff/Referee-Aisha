...
const TopicsAndCorrections: React.FC<TopicsAndCorrectionsProps> = ({
  ...
  return (
    <div className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-3">Topics & Corrections</label>
        
        {topicPairs.map((pair, index) => (
          <div key={pair.id} className="relative border border-gray-200 rounded-lg p-4 bg-gray-50 mb-4">
